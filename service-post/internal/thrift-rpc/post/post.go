...
func (p *PostServiceClient) Ping(ctx context.Context) (r *PingResponse, err error) {
	var _args0 PostServicePingArgs
	var _result1 PostServicePingResult
...
func NewPostServiceProcessor(handler PostService) *PostServiceProcessor {
	...
	self2 := &PostServiceProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self2.processorMap["ping"] = &postServiceProcessorPing{handler: handler}
	return self2
}
...
type postServiceProcessorPing struct {
	handler PostService
}

func (p *postServiceProcessorPing) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := PostServicePingArgs{}
...
type PostServicePingArgs struct {
}

func NewPostServicePingArgs() *PostServicePingArgs {
	return &PostServicePingArgs{}
}

func (p *PostServicePingArgs) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *PostServicePingArgs) Write(oprot thrift.TProtocol) error {
...
func (p *PostServicePingArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("PostServicePingArgs(%+v)", *p)
}

// Attributes:
//  - Success
type PostServicePingResult struct {
	Success *PingResponse `thrift:"success,0" db:"success" json:"success,omitempty"`
}

func NewPostServicePingResult() *PostServicePingResult {
	return &PostServicePingResult{}
}

var PostServicePingResult_Success_DEFAULT *PingResponse

func (p *PostServicePingResult) GetSuccess() *PingResponse {
	if !p.IsSetSuccess() {
		return PostServicePingResult_Success_DEFAULT
	}
	return p.Success
}
func (p *PostServicePingResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *PostServicePingResult) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *PostServicePingResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *PostServicePingResult) Write(oprot thrift.TProtocol) error {
...
func (p *PostServicePingResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
...
func (p *PostServicePingResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("PostServicePingResult(%+v)", *p)
}
